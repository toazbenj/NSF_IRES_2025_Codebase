...
#include "traj_planning_msg/msg/detail/trajectory_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const traj_planning_msg::msg::Trajectory &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  traj_planning_msg::msg::Trajectory &);
...
cdr_serialize(
  const traj_planning_msg::msg::TrajectoryList & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  traj_planning_msg::msg::TrajectoryList & ros_message)
{
  // Member: paths
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: paths
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        traj_planning_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_Trajectory(
  ...
  if (is_plain) {
    ...
    using DataType = traj_planning_msg::msg::TrajectoryList;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const traj_planning_msg::msg::TrajectoryList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<traj_planning_msg::msg::TrajectoryList *>(
    untyped_ros_message);
...
{
  return &traj_planning_msg::msg::typesupport_fastrtps_cpp::_TrajectoryList__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, traj_planning_msg, msg, TrajectoryList)() {
  return &traj_planning_msg::msg::typesupport_fastrtps_cpp::_TrajectoryList__handle;
}
