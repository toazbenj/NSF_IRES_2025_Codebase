...
bool traj_planning_msg__msg__speed_path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("traj_planning_msg.msg._speed_path.SpeedPath", full_classname_dest, 43) == 0);
  }
  traj_planning_msg__msg__SpeedPath * ros_message = _ros_message;
  {  // path
...
{
  /* NOTE(esteve): Call constructor of SpeedPath */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("traj_planning_msg.msg._speed_path");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SpeedPath");
  ...
  traj_planning_msg__msg__SpeedPath * ros_message = (traj_planning_msg__msg__SpeedPath *)raw_ros_message;
  {  // path
    PyObject * field = NULL;
