...
class Metaclass_SpeedPath(type):
    """Metaclass of message 'SpeedPath'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__speed_path
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__speed_path
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__speed_path
            cls._TYPE_SUPPORT = module.type_support_msg__msg__speed_path
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__speed_path
...
class SpeedPath(metaclass=Metaclass_SpeedPath):
    """Message class 'SpeedPath'."""
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import Float64
        self.speed = kwargs.get('speed', Float64())
    ...
    def speed(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'speed' field must be a sub message of type 'Float64'"
        self._speed = value
