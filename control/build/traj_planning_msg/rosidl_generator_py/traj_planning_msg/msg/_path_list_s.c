...
bool traj_planning_msg__msg__path_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("traj_planning_msg.msg._path_list.PathList", full_classname_dest, 41) == 0);
  }
  traj_planning_msg__msg__PathList * ros_message = _ros_message;
  {  // paths
...
{
  /* NOTE(esteve): Call constructor of PathList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("traj_planning_msg.msg._path_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PathList");
