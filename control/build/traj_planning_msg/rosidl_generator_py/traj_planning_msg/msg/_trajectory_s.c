...
bool traj_planning_msg__msg__trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("traj_planning_msg.msg._trajectory.Trajectory", full_classname_dest, 44) == 0);
  }
  traj_planning_msg__msg__Trajectory * ros_message = _ros_message;
  {  // header
...
PyObject * traj_planning_msg__msg__trajectory__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("traj_planning_msg.msg._trajectory");
