...
static PyMethodDef traj_planning_msg__methods[] = {
  {NULL, NULL, 0, NULL}  /* sentinel */
};

static struct PyModuleDef traj_planning_msg__module = {
  PyModuleDef_HEAD_INIT,
  "_traj_planning_msg_support",
  "_traj_planning_msg_doc",
  -1,  /* -1 means that the module keeps state in global variables */
  traj_planning_msg__methods,
  NULL,
  NULL,
  NULL,
  NULL,
...
PyMODINIT_FUNC
PyInit_traj_planning_msg_s__rosidl_typesupport_introspection_c(void)
{
  PyObject * pymodule = NULL;
  pymodule = PyModule_Create(&traj_planning_msg__module);
  if (!pymodule) {
    return NULL;
  }
  int8_t err;
