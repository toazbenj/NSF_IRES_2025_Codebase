...
static const _TrajectoryList_type_support_symbol_names_t _TrajectoryList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, traj_planning_msg, msg, TrajectoryList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, traj_planning_msg, msg, TrajectoryList)),
  }
};
...
{
  return &::traj_planning_msg::msg::rosidl_typesupport_cpp::TrajectoryList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, traj_planning_msg, msg, TrajectoryList)() {
  return get_message_type_support_handle<traj_planning_msg::msg::TrajectoryList>();
}
