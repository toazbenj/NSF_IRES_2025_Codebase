...
{
  new (message_memory) traj_planning_msg::msg::TrajectoryList(_init);
}

void TrajectoryList_fini_function(void * message_memory)
{
  auto typed_message = static_cast<traj_planning_msg::msg::TrajectoryList *>(message_memory);
  typed_message->~TrajectoryList();
}

size_t size_function__TrajectoryList__paths(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<traj_planning_msg::msg::Trajectory> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<traj_planning_msg::msg::Trajectory> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<traj_planning_msg::msg::Trajectory> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const traj_planning_msg::msg::Trajectory *>(
    get_const_function__TrajectoryList__paths(untyped_member, index));
  auto & value = *reinterpret_cast<traj_planning_msg::msg::Trajectory *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<traj_planning_msg::msg::Trajectory *>(
    get_function__TrajectoryList__paths(untyped_member, index));
  const auto & value = *reinterpret_cast<const traj_planning_msg::msg::Trajectory *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrajectoryList_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<traj_planning_msg::msg::Trajectory>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(traj_planning_msg::msg::TrajectoryList, paths),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrajectoryList_message_members = {
  ...
  1,  // number of fields
  sizeof(traj_planning_msg::msg::TrajectoryList),
...
get_message_type_support_handle<traj_planning_msg::msg::TrajectoryList>()
{
  return &::traj_planning_msg::msg::rosidl_typesupport_introspection_cpp::TrajectoryList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, traj_planning_msg, msg, TrajectoryList)() {
  return &::traj_planning_msg::msg::rosidl_typesupport_introspection_cpp::TrajectoryList_message_type_support_handle;
}
