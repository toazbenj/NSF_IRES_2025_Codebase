...
class Metaclass_PathList(type):
    """Metaclass of message 'PathList'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'traj_planning_msg.msg.PathList')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__path_list
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__path_list
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__path_list
...
class PathList(metaclass=Metaclass_PathList):
    """Message class 'PathList'."""
