...
#include "local_planner_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_local_planner_msgs
...
using _Trajectory__ros_msg_type = local_planner_msgs__msg__Trajectory;
...
static uint32_t _Trajectory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_local_planner_msgs__msg__Trajectory(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = local_planner_msgs__msg__Trajectory;
    is_plain =
      (
...
static size_t _Trajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_local_planner_msgs__msg__Trajectory(
