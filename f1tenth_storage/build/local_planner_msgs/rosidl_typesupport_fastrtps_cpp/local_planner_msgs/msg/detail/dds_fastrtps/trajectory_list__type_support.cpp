...
#include "local_planner_msgs/msg/detail/trajectory_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const local_planner_msgs::msg::Trajectory &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  local_planner_msgs::msg::Trajectory &);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: paths
  {
    ...
    for (size_t i = 0; i < size; i++) {
      local_planner_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.paths[i],
        cdr);
    }
  }
  ...
  local_planner_msgs::msg::TrajectoryList & ros_message)
{
  // Member: paths
  {
    ...
    for (size_t i = 0; i < size; i++) {
      local_planner_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: paths
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        local_planner_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: paths
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        local_planner_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Trajectory(
  ...
  if (is_plain) {
    ...
    using DataType = local_planner_msgs::msg::TrajectoryList;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const local_planner_msgs::msg::TrajectoryList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<local_planner_msgs::msg::TrajectoryList *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_local_planner_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<local_planner_msgs::msg::TrajectoryList>()
{
  return &local_planner_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryList__handle;
}
