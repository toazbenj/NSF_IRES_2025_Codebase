...
#include "local_planner_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const local_planner_msgs::msg::Trajectory & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  local_planner_msgs::msg::Trajectory & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = local_planner_msgs::msg::Trajectory;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const local_planner_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<local_planner_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
get_message_type_support_handle<local_planner_msgs::msg::Trajectory>()
{
  return &local_planner_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, local_planner_msgs, msg, Trajectory)() {
  return &local_planner_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
