...
static const _TrajectoryList_type_support_symbol_names_t _TrajectoryList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, local_planner_msgs, msg, TrajectoryList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, local_planner_msgs, msg, TrajectoryList)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, local_planner_msgs, msg, TrajectoryList)() {
  return &::local_planner_msgs::msg::rosidl_typesupport_c::TrajectoryList_message_type_support_handle;
}
