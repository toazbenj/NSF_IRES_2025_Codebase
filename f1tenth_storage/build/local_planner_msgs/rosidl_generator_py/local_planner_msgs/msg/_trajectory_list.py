...
class Metaclass_TrajectoryList(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('local_planner_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'local_planner_msgs.msg.TrajectoryList')
            logger.debug(
            ...
            from local_planner_msgs.msg import Trajectory
...
class TrajectoryList(metaclass=Metaclass_TrajectoryList):
    ...
    _fields_and_field_types = {
        'paths': 'sequence<local_planner_msgs/Trajectory>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['local_planner_msgs', 'msg'], 'Trajectory')),  # noqa: E501
    )
