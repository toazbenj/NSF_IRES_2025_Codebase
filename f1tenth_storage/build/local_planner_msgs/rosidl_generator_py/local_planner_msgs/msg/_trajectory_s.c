...
bool local_planner_msgs__msg__trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("local_planner_msgs.msg._trajectory.Trajectory", full_classname_dest, 45) == 0);
  }
  local_planner_msgs__msg__Trajectory * ros_message = _ros_message;
  {  // header
  ...
  {  // speed
    ...
    if (!std_msgs__msg__float64__convert_from_py(field, &ros_message->speed)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * local_planner_msgs__msg__trajectory__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("local_planner_msgs.msg._trajectory");
  ...
  {  // speed
    PyObject * field = NULL;
    field = std_msgs__msg__float64__convert_to_py(&ros_message->speed);
    if (!field) {
      return NULL;
    }
    {
